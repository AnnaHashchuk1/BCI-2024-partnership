...
export function WhyPoint({ idx, title, description }: WhyPointProps) {
  return (
    <div
      className="flex gap-4 w-[90%] lg:w-[65%] rounded-2xl p-8 bg-bci-purple text-left justify-between"
    ...
    >
      ...
      <div className="sm:w-[100%] md:w-[75%]">
        <div className="text-lg lg:text-2xl font-bold text-white mb-5">{title}</div>
        <div className="text-md lg:text-xl text-white">{description}</div>
      </div>
