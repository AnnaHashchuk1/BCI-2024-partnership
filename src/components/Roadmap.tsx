...
const Roadmap = () => {
  ...
  return (
    <div className="h-screen w-full bg-bci-gray">
      <div className="container mx-auto h-full flex flex-col items-center justify-center gap-8 xl:gap-20 p-5 md:p-10 text-bci-white">
        <h3 className="font-montserrat font-bold text-center text-xl sm:text-4xl md:text-5xl xl:text-7xl transition-all">
