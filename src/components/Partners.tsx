...
export default function Partners() {
  ...
  return (
    <div className="mt-[65px]">
      <h2 className="text-2xl md:text-[42px] lg:text-[64px] w-[100%] md:w-[75%] mx-auto leading-8 md:leading-[70px] text-white text-center font-montserrat mb-6 md:mb-10 font-bold">
