...
export default function Statistics() {
  ...
  return (
    <section
      id="statistic"
      className="w-full min-h-screen bg-bci-gray flex flex-col items-center gap-8 px-6"
    >
      <h2 className="text-bci-white text-5xl font-montserrat font-bold mt-32 lg:mt-44 lg:text-6xl">
        Попередні метрики BEST’у
      </h2>
      <div className="flex flex-col container mx-auto justify-center gap-6 mb-20 lg:grid lg:mb-44 grid-cols-2">
